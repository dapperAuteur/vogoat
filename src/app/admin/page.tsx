...
const TOOLS = [
  { href: "/admin/analytics", name: "Usage analytics", detail: "The funnel, habit, and what players use versus avoid" },
  { href: "/admin/campaigns", name: "Campaigns", detail: "Write and send announcements to players who opted in" },
