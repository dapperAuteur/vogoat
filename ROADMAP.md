...
| 4 | Recorder + takes: MediaRecorder, 30s cap, keep/discard, 3/day free, private Blob upload, submit | Server core done 2026-09-01 (register/keep/discard/submit + blob store + owner-only playback, tested); recorder UI next |
| 5 | Payoff + Menagerie: plate fills in, streaks, silhouettes for missed days, 30-day expiry cron | Not started |
| 6 | Share: spoiler-free text card, plate image, unguessable audio page (noindex, revoke, report) | Not started |
